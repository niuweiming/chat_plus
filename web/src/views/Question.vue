    ...
    >
      <div class="notice">
        ...
        <p style="text-align: right">
          <el-button @click="notShow" type="success" plain
            >我知道了，不再显示</el-button
          >
        </p>
      </div>
...
const connect = function (chat_id, role_id) {
  ...
  const sendHeartbeat = () => {
    ...
    new Promise((resolve, reject) => {
      if (socket.value !== null) {
        socket.value.send(
          JSON.stringify({ type: "heartbeat", content: "ping" })
        );
      }
      resolve("success");
    }).then(() => {
  ...
  switch (chocice_chat.value) {
    case "BOTd252fd34980247d9813b87be54241072":
      httpPost("api/chatbot/new", {
        ...
        chatid: "",
        user_id: "",
        bot_id: "BOTd252fd34980247d9813b87be54241072",
    ...
    case "BOT323a8aecc5204dbba89f3485b8ebc592":
      httpPost("api/chatbot/new", {
        ...
        chatid: "",
        user_id: "",
        bot_id: "BOT323a8aecc5204dbba89f3485b8ebc592",
        question: prompt.value,
      })
        .then((res) => {
          console.log(res);
    ...
    case "BOT40b024cec5b34d67961d135560247d40":
      httpPost("api/chatbot/new", {
        ...
        chatid: "",
        user_id: "",
        bot_id: "BOT40b024cec5b34d67961d135560247d40",
        question: prompt.value,
      })
        .then((res) => {
          console.log(res);
    ...
    default:
      console.log("ws  发送");
      socket.value.send(
        JSON.stringify({ type: "chat", content: prompt.value })
      );
...
const reGenerate = function () {
  ...
  socket.value.send(
    JSON.stringify({ type: "chat", content: previousText.value })
  );
};
